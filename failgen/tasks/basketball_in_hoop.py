...
Import-safe task module for a Franka basketball-in-hoop task matched to:
...
# 3. Task parameters.
# ----------------------------------------------------------------------
# AHA/RLBench TTM inspection values from:
#   /home/ramtin/AHA/ttm_inspection_reports/001_basketball_in_hoop.llm_context.md
AHA_BALL_WORLD_POS_XYZ = [0.010810, 0.013532, 0.781336]
AHA_HOOP_WORLD_DELTA_FROM_BALL_XYZ = [0.268931, 0.053856, 0.224390]
AHA_WORKSPACE_TOP_Z = 0.752000
AHA_TABLE_CENTER_XY = (0.300000, 0.000000)
AHA_TABLE_SIZE_XYZ = (1.600001, 1.100001, 0.750001)
AHA_BALL_RADIUS = 0.030000
AHA_HOOP_RESPONDABLE_SIZE_XYZ = (0.190450, 0.423518, 0.467437)
AHA_HOOP_VISUAL_SIZE_XYZ = (0.394375, 0.426962, 0.584685)
AHA_PANDA_BASE_XY = (-0.308951, 0.000000)
AHA_WAYPOINT1_FROM_BALL_XYZ = [0.000217, -0.005512, 0.012424]
AHA_WAYPOINT0_UP_FROM_WAYPOINT1_Z = 0.077
AHA_WAYPOINT2_UP_FROM_WAYPOINT1_Z = 0.355
AHA_WAYPOINT3_WORLD_DELTA_FROM_HOOP_XYZ = [-0.033463, -0.006532, 0.080595]

TABLE_HEIGHT = AHA_WORKSPACE_TOP_Z
TABLE_CENTER_XY = AHA_TABLE_CENTER_XY
TABLE_SIZE = AHA_TABLE_SIZE_XYZ
GRAVITY_XYZ = (0.0, 0.0, -9.81)
ROBOT_DISABLE_GRAVITY_FOR_STABLE_IK = True
ROBOT_BASE_POS_XYZ = (AHA_PANDA_BASE_XY[0], AHA_PANDA_BASE_XY[1], TABLE_HEIGHT)

BALL_RADIUS = AHA_BALL_RADIUS
BALL_MASS = 0.035
BALL_POS_XYZ = AHA_BALL_WORLD_POS_XYZ
HOOP_OFFSET_FROM_BALL_XYZ = AHA_HOOP_WORLD_DELTA_FROM_BALL_XYZ
HOOP_CENTER_XYZ = [
...
HOOP_SUPPORT_HEIGHT = HOOP_CENTER_XYZ[2] - TABLE_HEIGHT

HOOP_OPENING = AHA_HOOP_RESPONDABLE_SIZE_XYZ[0]
...
HOOP_BACKBOARD_SIZE = (0.014, AHA_HOOP_VISUAL_SIZE_XYZ[1], AHA_HOOP_VISUAL_SIZE_XYZ[2])
...
# AHA placement distribution for the graspable ball. This module uses the
# inspected live pose above for deterministic IsaacLab replay.
...
GRIPPER_OPEN = 0.04
# Panda finger joints are per-finger; total opening ~= 2 * joint value.
GRIPPER_CLOSED = 0.0270  # gap ~= 5.4 cm on the AHA 6 cm ball
HAND_TO_BALL_Z = BALL_RADIUS + 0.063
AHA_WAYPOINT0_HAND_OFFSET_XYZ = [
    AHA_WAYPOINT1_FROM_BALL_XYZ[0],
    AHA_WAYPOINT1_FROM_BALL_XYZ[1],
    HAND_TO_BALL_Z + AHA_WAYPOINT0_UP_FROM_WAYPOINT1_Z,
]
AHA_WAYPOINT1_HAND_OFFSET_XYZ = [
    AHA_WAYPOINT1_FROM_BALL_XYZ[0],
    AHA_WAYPOINT1_FROM_BALL_XYZ[1],
    HAND_TO_BALL_Z,
]
AHA_WAYPOINT2_DELTA_XYZ = [0.0, 0.0, AHA_WAYPOINT2_UP_FROM_WAYPOINT1_Z]
MIN_BALL_LIFT_FOR_HOOP = 0.06
AHA_WAYPOINT3_APPROACH_DELTA_Z = 0.16
...
SUBGOAL_PARAMS = [
    {
        ...
        "reference": "ball",
        "offset_xyz": AHA_WAYPOINT0_HAND_OFFSET_XYZ,
        "gripper": "open",
        "duration_steps": 220,
    },
    {
        ...
        "reference": "ball",
        "offset_xyz": AHA_WAYPOINT1_HAND_OFFSET_XYZ,
        "gripper": "open",
        "duration_steps": 160,
    },
    {
    ...
    },
    {
        ...
        "reference": "previous",
        "delta_xyz": AHA_WAYPOINT2_DELTA_XYZ,
        "gripper": "closed",
        "duration_steps": 260,
    },
    {
        "label": "approach waypoint3 above hoop",
        "reference": "hoop",
        "offset_xyz": [
            AHA_WAYPOINT3_WORLD_DELTA_FROM_HOOP_XYZ[0],
            AHA_WAYPOINT3_WORLD_DELTA_FROM_HOOP_XYZ[1],
            AHA_WAYPOINT3_WORLD_DELTA_FROM_HOOP_XYZ[2] + AHA_WAYPOINT3_APPROACH_DELTA_Z,
        ],
        "gripper": "closed",
        "duration_steps": 320,
    },
    {
        ...
        "reference": "hoop",
        "offset_xyz": AHA_WAYPOINT3_WORLD_DELTA_FROM_HOOP_XYZ,
        "gripper": "closed",
        "duration_steps": 180,
    },
    {
    ...
    },
    {
        ...
        "reference": "hoop",
        "offset_xyz": [
            AHA_WAYPOINT3_WORLD_DELTA_FROM_HOOP_XYZ[0] + HOOP_RETREAT_OFFSET_X,
            AHA_WAYPOINT3_WORLD_DELTA_FROM_HOOP_XYZ[1],
            AHA_WAYPOINT3_WORLD_DELTA_FROM_HOOP_XYZ[2] + HOOP_RETREAT_CLEARANCE_Z,
        ],
        "gripper": "open",
        "duration_steps": 200,
    },
...
class FrankaBasketballSceneCfg(InteractiveSceneCfg):
    ...
    table = RigidObjectCfg(
        ...
        init_state=RigidObjectCfg.InitialStateCfg(pos=(TABLE_CENTER_XY[0], TABLE_CENTER_XY[1], TABLE_SIZE[2] / 2.0)),
    )
...
def run_simulator(simulation_app, sim: sim_utils.SimulationContext, scene: InteractiveScene, failure=None):
    robot = scene["robot"]
    ball = scene["ball"]
    num_envs = scene.num_envs
    failure = failure if failure is not None else _NoFailure()
    ...
    failure.on_task_start(failure_context)
    ...
    for params in SUBGOAL_PARAMS:
        ...
        failure.on_subgoal_start(label, failure_context)
        ...
        for phase_step in range(duration):
            ...
            commanded_grip = failure.update_gripper_target(nominal_grip, failure_context)
            _set_gripper(
                robot,
        ...
        failure.on_subgoal_complete(label, failure_context)
...
def run_task(simulation_app, failure=None):
    sim, scene = build_simulation()
    print("[INFO]: Basketball scene ready. Starting task.")
    run_simulator(simulation_app, sim, scene, failure=failure)
